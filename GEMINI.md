...
This file helps Gemini understand the project's context, conventions, and important details.
...
- `chatbot`: Runs the chatbot application using certain environment variables. If running in a VSCode terminal, they typically are automatically loaded from the `.env` file in the project root.
